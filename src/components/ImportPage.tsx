...
export const ImportPage: FC = () => {
    ...
    const handlePlainTextImport = useCallback(
        (content: string) => {
            setParseError(null);
            ...
            try {
                ...
                if (albums.length === 0) {
                    setParseError(
                        "No albums found in the input. Expected format: Artist - Album",
                    );
                    return;
                }
        ...
        (content: string) => {
            ...
            try {
                ...
                if ((rawData.rows[0]?.length || 0) < 2) {
                    setParseError(
                        "CSV must have at least 2 columns to map Artist and Album.",
                    );
                    return;
                }
    ...
    useEffect(() => {
        ...
        if (
            ...
            !hasStartedMatching.current &&
            currentImport.items.length > 0
        ) {
        ...
        <div className="import-page">
            ...
            <div className="import-section">
                ...
                <p className="import-hint">
                    Upload a CSV file or paste your list. For CSV files, you'll
                    be able to map which columns contain the Artist and Album
                    information.
                    <br />
...
The Beatles - Abbey Road`}
            ...
            {pendingItems.length > 0 && (
                <div className="import-section import-section--pending">
                    ...
                    <p className="import-hint">
                        These items were previously unmatched. You can retry
                        matching them or export for later.
                    </p>
                            ...
                            <div key={item.id} className="pending-item">
                                ...
                                <div className="pending-item__actions">
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            dispatch(removeFromPending(item.id))
                                        }
                                    >
                                        Remove
                                    </button>
