...
export const SettingsPage: FC = () => {
    ...
    const generateShareLink = async () => {
        ...
        const link = password
            ? `${baseUrl}?room=${encodeURIComponent(room)}&password=${encodeURIComponent(password)}`
            ...
            <div className="stack" style={{ "--space": "var(--s1)" }}>
                ...
                <div className="settings-group settings-group--sync">
                    ...
                    <div className="sync-room">
                        <div
                            className="sync-room__fields switcher"
                            style={{ "--switcher-target": "20rem" }}
                        >
                            <div
                                className="sync-room__field stack"
                                style={{ "--space": "0.25rem" }}
                            >
                        ...
                        <div className="sync-room__share">
                            ...
                            {shareLink && (
                                <div className="share-link">
                                    <div
                                        className="switcher share-link__row"
                                        style={{ "--switcher-target": "20rem" }}
                                    >
                                        <input
                                            type="text"
                    ...
                    <span className="setting-hint">
                        Set a room name and optional password, then generate a
                        share link to sync with others.
                    </span>
                </div>
                ...
                <div className="settings-group">
                    ...
                    />
                    <span className="setting-hint">
                        WebSocket URL for the WebRTC signaling server. One per
                        line for multiple.
                    </span>
                </div>
                ...
                <div className="settings-group">
                    ...
                    />
                    <span className="setting-hint">
                        Maximum number of WebRTC connections per client.
                    </span>
                </div>
                ...
                <div className="settings-group settings-group--checkbox">
                    ...
                    <span className="setting-hint">
                        When enabled, tabs in the same browser share data via
                        BroadcastChannel instead of WebRTC.
                    </span>
                </div>
                ...
                <div className="settings-group">
                    ...
                    <div className="data-source-list">
                        ...
                        {dataSources.map((url, i) => (
                            <div key={i} className="data-source-list__row">
                                <input
                                    ...
                                    value={url}
                                    onChange={(e) =>
                                        updateDataSource(i, e.target.value)
                                    }
                                    placeholder="https://raw.githubusercontent.com/user/repo/master/cds.json"
                                    className="data-source-list__input"
                                />
                                <span
                                    className={`data-source-list__status data-source-list__status--${url ? dataSourceStatuses[url] || "untested" : "empty"}`}
                                >
                                    {url
                                        ? dataSourceStatuses[url] === "testing"
                                            ? "Testing..."
                                            : dataSourceStatuses[url] ===
                                                "success"
                                              ? "✓ OK"
                                              : dataSourceStatuses[url] ===
                                                  "error"
                        ...
                        <div className="data-source-list__actions cluster">
                            <button
                                type="button"
                    ...
                    <span className="setting-hint">
                        URLs to JSON files containing CD wishlist data.
                    </span>
                </div>

                <div className="settings-group">
                    <label htmlFor="iceServers">
                    ...
                    />
                    <span className="setting-hint">
                        STUN/TURN servers for NAT traversal. One URL per line.
                    </span>
                </div>
